...
I developed a chat application using Express, Websockets. Tough you can use plain websockets but I would be using a library called Socket.io - which is wrapper around Websockets, its super easy to use and provies a fallback to xhr requests until the websocket connection is established.
...
Socket.IO is a realtime messaging library for JavaScript developers that is based on WebSocket.
